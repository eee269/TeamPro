...
public class DefaultAddrAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(member_id == null) {
			...
			ArrayList<AddrBean> defaultAddr = new ArrayList<AddrBean>();
			
			defaultAddr = addrService.getDefaultAddr(member_id,addrType);
			
			request.setAttribute("addrList", defaultAddr);
			System.out.println("arraylist : " +defaultAddr.get(0).getPostcode());
