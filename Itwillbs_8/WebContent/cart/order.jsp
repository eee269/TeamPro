		...
		<div id="content">
			<div id="order">
				...
				<div class="page-body">
					...
					<form name="form1" id="order_form" action="OrderPro.or"
						method="post">
						...
						<fieldset>
								...
								<table>
									...
									<tbody>
										<tr>
											...
											<td><input type="hidden" name="sender" form="order_form"
												id="sender" class="MS_input_txt"></td>
										</tr>
										<tr>
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td colspan="3"><input type="text" name="post1"
												id="post1" form="order_form" size="6"
												class="MS_input_txt w60" onclick=""> <a
										...
										<tr>
											...
											<td>
												<div class="base">
													...
													<a class="plus"><img src="cart/img/bul_h23_plus.png"
											...
											<td>
												<div class="base">
													...
													<a class="plus" style="display: none;"><img
														src="cart/img/bul_h23_plus.png" alt="plus"></a><a
														class="minus"><img src="cart/img/bul_h23_minus.png"
														alt="minus"></a>
												</div>
											</td>
											<td>
							...
							<div id="paybutton">
								<a href="javascript:send();" class="CSSbuttonBlack"><input
									type="submit" value="주문하기"></a> <a
